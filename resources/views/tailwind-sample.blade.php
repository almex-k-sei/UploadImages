...
<body class="font-mono text-gray-800">
    ...
    <div class="box-border md:container md:mx-auto">
        ...
        <div class="space-y-4">
            <div class="w-96 bg-indigo-500 shadow rounded">
                w-96
            </div>
            <div class="w-64 bg-indigo-600 shadow rounded">
                w-64
            </div>
            <div class="w-52 text-gray-100 bg-indigo-700 shadow rounded">
                w-52
            </div>
            <div class="w-28 text-gray-100 bg-indigo-800 shadow rounded">
                w-28
            </div>
        </div>
